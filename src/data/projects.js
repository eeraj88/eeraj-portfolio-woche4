const projects = [
  {
    id: 1,
    titel: "Wetter-App",
    beschreibung: "Moderne Wetter-Anwendung mit Echtzeit-Daten von OpenWeatherMap API. Features: Stadtsuche, 5-Tage-Prognose, Favoriten speichern, und responsive Design.",
